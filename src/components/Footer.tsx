...
const Footer = () => {
  return (
    <footer className="bg-white pt-16 pb-8 border-t border-border/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              Connecting qualified tutors with students for personalized in-home learning experiences.
            </p>
          ...
          {/* Column 3 - Subjects */}
          <div>
            <h3 className="text-base font-semibold mb-4">Subjects</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-muted-foreground hover:text-primary transition-colors">
                  Mathematics
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@tutorspace.com" className="text-muted-foreground hover:text-primary transition-colors">
                  info@tutorspace.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-border/30 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} TutorSpace. All rights reserved.
            </p>
